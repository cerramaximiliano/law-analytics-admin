...
const TriggersSocial = Loadable(lazyWithRetry(() => import("pages/admin/social/triggers")));
...
const GoogleAdsImagenes = Loadable(lazyWithRetry(() => import("pages/admin/social/google-ads")));

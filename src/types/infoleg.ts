...
export type InfolegTipo =
  | 'ley' | 'decreto' | 'decreto_ley' | 'decreto_reglamentario' | 'decreto_dnu'
  | 'resolucion' | 'resolucion_general' | 'resolucion_administrativa'
  | 'decision_administrativa' | 'disposicion' | 'disposicion_conjunta'
  | 'acuerdo' | 'convenio' | 'otro';

					...
					>
						<Stack spacing={1.5}>
							...
							<Typography variant="body2" color="text.secondary">
								Gestión de workers para el sistema PJ Mendoza (portal IOL del Poder Judicial de Mendoza) — Verificación, actualización y liberación de causas
							</Typography>
						</Stack>
					</MainCard>
				</Grid>
				...
				<DialogContent>
					<Stack spacing={2} sx={{ pt: 1 }}>
						<Alert severity="info" variant="outlined">
							El cambio se guarda inmediatamente, pero requiere reiniciar el proceso PM2 <code>pjmendoza-workers-manager</code> en producción para aplicar.
						</Alert>
						<CronSelector
							label="Frecuencia"

					...
					<Box>
						...
						<Stack spacing={2}>
							<Box>
								...
								<Typography variant="body2" color="text.secondary">
									Verifica que los expedientes existan en PJ Mendoza. Maneja 3 escenarios: no encontrado, único resultado, múltiples
									resultados.
								</Typography>
							</Box>
							<Divider />
			...
			<TabPanel value={tabValue} index={1}>
				<Stack spacing={3}>
					...
					<Alert severity="info" sx={{ mb: 2 }}>
						<strong>Valores de isValid:</strong> <code>null</code> = pendiente, <code>true</code> = existe en PJ Mendoza, <code>false</code>{" "}
						= no existe
					</Alert>
...
└─────────────────────┘     └─────────────────────┘     └─────────────────────┘`}
			...
			<TabPanel value={tabValue} index={5}>
				<Stack spacing={3}>
					...
					<Alert severity="info">
						El sistema trackea todos los cambios de estado en la vinculación de causas PJ Mendoza, permitiendo auditar el ciclo de vida

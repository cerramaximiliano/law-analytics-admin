 ...
 * Organiza toda la documentación de PJ Mendoza Workers
 */
	...
	return (
		<Stack spacing={2}>
			...
			<Alert severity="info" sx={{ mb: 1 }}>
				Scripts disponibles para probar y mantener los workers de PJ Mendoza.
			</Alert>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`MONGODB_URI=mongodb://...
API_KEY=tu-api-key
PJMENDOZA_API_URL=https://pjmendoza.lawanalytics.app
...
npx ts-node scripts/test-verification-flow.ts 162321/2020 162512/2020`}
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`1. Conecta a MongoDB
2. Crea documento CausasPjMendoza temporal (TEMP-xxx)
					...
					<Box>
						...
						<Stack spacing={2}>
							<Box>
								...
								<Typography variant="body2" color="text.secondary">
									Verifica que los expedientes existan en PJ Mendoza. Maneja 3 escenarios: no encontrado, único resultado, múltiples resultados.
								</Typography>
							</Box>
							<Divider />
							<Box>
			...
			<TabPanel value={tabValue} index={1}>
				<Stack spacing={3}>
					...
					<Alert severity="info" sx={{ mb: 2 }}>
						<strong>Valores de isValid:</strong> <code>null</code> = pendiente, <code>true</code> = existe en PJ Mendoza, <code>false</code> = no
						existe
					</Alert>
						...
						<Grid item xs={12} md={4}>
							...
							>
								...
								<Typography variant="body2" gutterBottom>
									El expediente no existe en PJ Mendoza:
								</Typography>
								<Stack spacing={0.5}>
			...
			<TabPanel value={tabValue} index={2}>
				<Stack spacing={3}>
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>Existe en PJ Mendoza</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>isPrivate</code>
					...
					<Box>
						...
						>
							<pre style={{ margin: 0 }}>
								{`CausaPjMendoza verificada (isValid=true)
        │
        ▼
┌───────────────────────────────────────────────────────────────┐
...
└─────────────────────┘     └─────────────────────┘     └─────────────────────┘`}
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>
											CausasPjMendoza creada con <code>verified: false</code>
										</TableCell>
									</TableRow>
									<TableRow>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Vincular expediente PJ Mendoza a folder</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="server" size="small" color="secondary" />
									...
									<TableRow>
										...
										<TableCell>Crear/vincular CausasPjMendoza</TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
			...
			<TabPanel value={tabValue} index={4}>
				<Stack spacing={3}>
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>No encontrado en PJ Mendoza</TableCell>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Flag expediente PJ Mendoza</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaId</code>
										...
										<TableCell>Referencia a CausasPjMendoza (o pivote)</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaType</code>
										...
										<TableCell>'CausasPjMendoza'</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
					...
					<Box>
						<Typography variant="subtitle1" fontWeight="bold" gutterBottom>
							Campos de CausasPjMendoza (Pivote)
						</Typography>
						<TableContainer>
							<Table size="small">
								<TableHead>
			...
			<TabPanel value={tabValue} index={5}>
				<Stack spacing={3}>
					...
					<Alert severity="info">
						El sistema trackea todos los cambios de estado en la vinculación de causas PJ Mendoza, permitiendo auditar el ciclo de vida completo de
						cada asociación.
					</Alert>
...
┌───────────────────┐
│  pending          │ ◄─── source: 'user'
│  "Causa PJ Mendoza       │      details: "Causa PJ Mendoza pendiente de verificación"
│   pendiente..."   │
└─────────┬─────────┘
          │
          ▼
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>Tracking en vinculación PJ Mendoza</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="law-analytics-server" size="small" color="secondary" />

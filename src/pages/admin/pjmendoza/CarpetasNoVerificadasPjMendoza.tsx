...
const CarpetasNoVerificadasPjMendoza = () => {
	...
	const fetchCausas = async (
		...
		try {
			...
			const response = await CausasPjMendozaService.getNonVerifiedCausas(params);
			...
			enqueueSnackbar("Error al cargar las carpetas no verificadas PJ Mendoza", {
				variant: "error",
	...
	return (
		<MainCard title="Carpetas no verificadas PJ Mendoza (App)">
			{/* Header: Resultados */}
			<Box sx={{ mb: 2 }}>
...
export default CarpetasNoVerificadasPjMendoza;

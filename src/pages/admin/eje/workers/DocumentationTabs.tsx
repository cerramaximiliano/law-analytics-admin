			...
			<TabPanel value={tabValue} index={1}>
				<Stack spacing={3}>
					...
					<Alert severity="info" sx={{ mb: 2 }}>
						<strong>Valores de isValid:</strong> <code>null</code> = pendiente, <code>true</code> = existe en EJE, <code>false</code> = no
						existe
					</Alert>
						...
						<Grid item xs={12} md={4}>
							...
							>
								...
								<Typography variant="body2" gutterBottom>
									El expediente no existe en EJE:
								</Typography>
								<Stack spacing={0.5}>
...
└─────────────────────┘     └─────────────────────┘     └─────────────────────┘`}
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>
											CausasEje creada con <code>verified: false</code>
										</TableCell>
									</TableRow>
									<TableRow>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Flag expediente EJE</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaId</code>
										...
										<TableCell>Referencia a CausasEje (o pivote)</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaType</code>
			...
			<TabPanel value={tabValue} index={5}>
				<Stack spacing={3}>
					...
					<Alert severity="info">
						El sistema trackea todos los cambios de estado en la vinculación de causas EJE, permitiendo auditar el ciclo de vida completo de
						cada asociación.
					</Alert>

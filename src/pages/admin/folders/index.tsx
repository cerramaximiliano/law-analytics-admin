								...
								<Table size="small">
									<TableHead>
										<TableRow>
											...
											<TableCell>Status Jud.</TableCell>
										...
										{folders.map((folder) => {
											...
											return (
												<TableRow key={folder._id} hover>
													...
													<TableCell>
														<Typography variant="caption">{folder.judFolder?.courtNumber || "-"}</Typography>
													</TableCell>
													<TableCell>
														<Typography variant="caption">{folder.judFolder?.statusJudFolder || "-"}</Typography>
													</TableCell>
													<TableCell>

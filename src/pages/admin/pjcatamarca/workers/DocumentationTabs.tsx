 ...
 * Organiza toda la documentación de PJ Catamarca Workers
 */
...
function TabPanel(props: TabPanelProps) {
	...
	return (
		<div role="tabpanel" hidden={value !== index} id={`doc-tabpanel-${index}`} aria-labelledby={`doc-tab-${index}`} {...other}>
...
function ScriptTabPanel(props: ScriptTabPanelProps) {
	const { children, value, index, ...other } = props;
	return (
		<div role="tabpanel" hidden={value !== index} id={`script-tabpanel-${index}`} aria-labelledby={`script-tab-${index}`} {...other}>
	...
	return (
		<Stack spacing={2}>
			...
			<Alert severity="info" sx={{ mb: 1 }}>
				Scripts disponibles para probar y mantener los workers de PJ Catamarca.
			</Alert>
				...
				<ScriptTabPanel value={scriptTab} index={0}>
					<Stack spacing={2}>
						...
						<Box>
							...
							<Box
								sx={{ p: 1.5, bgcolor: alpha(theme.palette.grey[500], 0.1), borderRadius: 1, fontFamily: "monospace", fontSize: "0.85rem" }}
							>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`MONGODB_URI=mongodb://...
API_KEY=tu-api-key
PJCATAMARCA_API_URL=https://pjcatamarca.lawanalytics.app
...
npx ts-node scripts/test-full-flow.ts 162321/2020`}
						...
						<Box>
							...
							<Box
								sx={{ p: 1.5, bgcolor: alpha(theme.palette.grey[500], 0.1), borderRadius: 1, fontFamily: "monospace", fontSize: "0.75rem" }}
							>
								<pre style={{ margin: 0 }}>
...
5. Opción de limpiar documentos de prueba`}
						...
						<Box>
							<Typography variant="subtitle2" fontWeight="bold" gutterBottom>
								Diferencia con test-verification-flow.ts
							</Typography>
							<TableContainer>
								<Table size="small">
									<TableHead>
...
npx ts-node scripts/test-verification-flow.ts 162321/2020 162512/2020`}
							...
							<TableContainer>
								<Table size="small">
									...
									<TableBody>
										<TableRow>
											<TableCell>
												<Chip label="CUIJ" size="small" color="primary" />
											</TableCell>
											<TableCell>
												<code>J-01-00053687-9/2020-0</code>
											</TableCell>
											<TableCell>Identificador único</TableCell>
										</TableRow>
										<TableRow>
											<TableCell>
												<Chip label="número/año" size="small" color="info" />
											</TableCell>
											<TableCell>
												<code>162321/2020</code>
											</TableCell>
											<TableCell>Número y año</TableCell>
										</TableRow>
										<TableRow>
											<TableCell>
												<Chip label="número" size="small" color="warning" />
											</TableCell>
											<TableCell>
												<code>15050</code>
											</TableCell>
							...
							<Grid container spacing={1}>
								<Grid item xs={12} md={4}>
									...
									>
										...
										<Typography variant="caption" display="block">
											<code>J-01-00070705-4/2019-0</code>
										</Typography>
									</Box>
								</Grid>
								<Grid item xs={12} md={4}>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`1. Conecta a MongoDB
2. Crea documento CausasPjCatamarca temporal (TEMP-xxx)
				...
				<ScriptTabPanel value={scriptTab} index={2}>
					<Stack spacing={2}>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>{`npx ts-node scripts/clean-cuij-prefixes.ts`}</pre>
							</Box>
						</Box>
							...
							<TableContainer>
								<Table size="small">
									...
									<TableBody>
										<TableRow>
											<TableCell>
												<code>EXP J-01-00015050-5/2021-0</code>
											</TableCell>
											<TableCell>
												<code>J-01-00015050-5/2021-0</code>
											</TableCell>
										</TableRow>
										<TableRow>
											<TableCell>
												<code>IPP J-02-00123456-7/2020-0</code>
											</TableCell>
											<TableCell>
												<code>J-02-00123456-7/2020-0</code>
											</TableCell>
										</TableRow>
										<TableRow>
											<TableCell>
												<code>EJF J-01-00054321-9/2019-0</code>
											</TableCell>
											<TableCell>
												<code>J-01-00054321-9/2019-0</code>
											</TableCell>
										</TableRow>
									</TableBody>
								</Table>
				...
				<ScriptTabPanel value={scriptTab} index={3}>
					<Stack spacing={2}>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>{`npx ts-node scripts/fix-linked-causas-history.ts`}</pre>
							</Box>
						</Box>
						...
						<Box>
							...
							<Stack spacing={1}>
								...
								<Typography variant="body2">
									2. Para cada pivot, obtiene sus <code>pivotCausaIds</code>
								</Typography>
								<Typography variant="body2">
									3. Identifica causas vinculadas sin <code>updateHistory</code>
								</Typography>
  ...
  details: {
    message: "Creado desde búsqueda con múltiples resultados.
              Término: \"162321/2020\". Pivot: <pivotId>"
						...
						<Alert severity="success">Las nuevas causas creadas desde pivots ya incluyen automáticamente esta entrada de historial.</Alert>
					</Stack>
				</ScriptTabPanel>
			</Box>
		</Stack>
		...
		<Box sx={{ display: "flex", bgcolor: "background.paper", borderRadius: 1, border: `1px solid ${theme.palette.divider}` }}>
			...
			<TabPanel value={tabValue} index={0}>
				<Stack spacing={3}>
					...
					<Alert severity="info">
						El sistema implementa una jerarquía de control de dos niveles que permite detener todos los workers con un solo interruptor o
					...
					<Box>
						...
						<Stack spacing={2}>
							<Box>
								...
								<Typography variant="body2" color="text.secondary">
									Verifica que los expedientes existan en PJ Catamarca. Maneja 3 escenarios: no encontrado, único resultado, múltiples resultados.
								</Typography>
							</Box>
							<Divider />
							<Box>
			...
			<TabPanel value={tabValue} index={1}>
				<Stack spacing={3}>
					<Typography variant="h6" fontWeight="bold">
						Flujo del Worker de Verificación
					</Typography>

					<Alert severity="info" sx={{ mb: 2 }}>
						<strong>Valores de isValid:</strong> <code>null</code> = pendiente, <code>true</code> = existe en PJ Catamarca, <code>false</code> = no
						existe
					</Alert>
...
└─────────────────────────────────────────────────────────────────────────────┘
   ...
   └───────────────┘          │   folder data)│          │   'pending_selection'
					...
					<Grid container spacing={2}>
						...
						<Grid item xs={12} md={4}>
							...
							>
								...
								<Typography variant="body2" gutterBottom>
									El expediente no existe en PJ Catamarca:
								</Typography>
								<Stack spacing={0.5}>
									...
									<Typography variant="caption">
										• <code>isPivot: false</code>
									</Typography>
									<Typography variant="caption">
										• <code>errorCount: +1</code>
									</Typography>
								</Stack>
						...
						<Grid item xs={12} md={4}>
							...
							>
								...
								<Typography variant="body2" gutterBottom>
									Varios expedientes coinciden:
								</Typography>
								<Stack spacing={0.5}>
									<Typography variant="caption">
										• Doc original → <strong>PIVOTE</strong>
									</Typography>
									<Typography variant="caption" sx={{ color: theme.palette.warning.main, fontWeight: "bold" }}>
										• <code>cuij: "PIVOT-xxx"</code>
									</Typography>
									<Typography variant="caption">
										• <code>isPivot: true</code>
									</Typography>
									<Typography variant="caption">
										• <code>pivotCausaIds: [...]</code>
									</Typography>
					...
					<Card variant="outlined" sx={{ borderColor: theme.palette.warning.main }}>
						...
						<CardContent>
							<Stack spacing={2}>
								...
								<Stack spacing={1}>
									<Typography variant="body2">
										• <strong>No tiene CUIJ válido</strong> - usa prefijo "PIVOT-{"{timestamp}"}-{"{id}"}"
									</Typography>
									<Typography variant="body2">
										• <strong>Sirve como ancla</strong> - el Folder apunta al pivote via <code>causaId</code>
									</Typography>
									<Typography variant="body2">
										• <strong>Contiene opciones</strong> - <code>pivotCausaIds</code> lista las causas posibles
									</Typography>
									<Typography variant="body2">
										• <strong>Se marca al resolver</strong> - <code>resolved: true</code> cuando usuario elige
									</Typography>
									<Typography variant="body2">
										• <strong>No se reutiliza</strong> - filtrado en búsquedas con{" "}
										<code>
											isPivot: {"{"} $ne: true {"}"}
										</code>
									</Typography>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>
											<Chip label="false" size="small" color="warning" />
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<Chip label="null" size="small" color="warning" />
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<Chip label="!= true" size="small" color="info" />
										</TableCell>
			...
			<TabPanel value={tabValue} index={2}>
				<Stack spacing={3}>
					<Typography variant="h6" fontWeight="bold">
						Flujo del Worker de Actualización
					</Typography>
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>Existe en PJ Catamarca</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>isPrivate</code>
										...
										<TableCell>
											<Chip label="false" size="small" color="info" />
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<Chip label="true" size="small" color="primary" />
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<Chip label="false" size="small" color="default" />
										</TableCell>
					...
					<Box>
						...
						>
							<pre style={{ margin: 0 }}>
								{`CausaPjCatamarca verificada (isValid=true)
        │
        ▼
┌───────────────────────────────────────────────────────────────┐
						...
						<Grid container spacing={2}>
							<Grid item xs={12} md={4}>
								<Box sx={{ p: 2, borderRadius: 1, bgcolor: alpha(theme.palette.primary.main, 0.05) }}>
									...
									<Typography variant="caption" color="text.secondary">
										Historial completo de actuaciones con fecha, tipo, descripción y firmante.
									</Typography>
								</Box>
							</Grid>
							<Grid item xs={12} md={4}>
								<Box sx={{ p: 2, borderRadius: 1, bgcolor: alpha(theme.palette.info.main, 0.05) }}>
									...
									<Typography variant="caption" color="text.secondary">
										Partes del proceso: actores, demandados, letrados, terceros.
									</Typography>
								</Box>
							</Grid>
							<Grid item xs={12} md={4}>
								<Box sx={{ p: 2, borderRadius: 1, bgcolor: alpha(theme.palette.success.main, 0.05) }}>
									...
									<Typography variant="caption" color="text.secondary">
										Expedientes acumulados, conexos o relacionados.
									</Typography>
								</Box>
							</Grid>
						</Grid>
...
└─────────────────────┘     └─────────────────────┘     └─────────────────────┘`}
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>
											<code>PUT /api/folders/link-causa/:folderId</code>
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>3</TableCell>
										<TableCell>
											<Chip label="eje-api" size="small" color="info" />
										</TableCell>
										<TableCell>
											<code>POST /causas-eje-service/associate-folder</code>
										</TableCell>
									</TableRow>
									<TableRow>
										...
										<TableCell>
											CausasPjCatamarca creada con <code>verified: false</code>
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>5</TableCell>
										<TableCell>
											<Chip label="Worker" size="small" color="warning" />
										</TableCell>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>
											<code>/api/folders/link-causa/:folderId</code>
										</TableCell>
										<TableCell>Vincular expediente PJ Catamarca a folder</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="server" size="small" color="secondary" />
										...
										<TableCell>PUT</TableCell>
										<TableCell>
											<code>/api/folders/select-causa/:folderId</code>
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<code>/causas-eje-service/associate-folder</code>
										</TableCell>
										<TableCell>Crear/vincular CausasPjCatamarca</TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
			...
			<TabPanel value={tabValue} index={4}>
				<Stack spacing={3}>
						...
						<TableContainer>
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										<TableCell>
											<Chip label="not_attempted" size="small" />
										</TableCell>
									...
									<TableRow sx={{ bgcolor: alpha(theme.palette.warning.main, 0.1) }}>
										<TableCell>
											<Chip label="pending_selection" size="small" color="warning" />
										</TableCell>
										<TableCell>Múltiples resultados encontrados</TableCell>
										<TableCell>
											<strong>Usuario selecciona</strong>
										</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
									...
									<TableRow>
										...
										<TableCell>No encontrado en PJ Catamarca</TableCell>
					...
					<Box>
						<Typography variant="subtitle1" fontWeight="bold" gutterBottom>
							Campos del Folder (PJ Catamarca)
						</Typography>
						<TableContainer>
							<Table size="small">
								<TableHead>
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Flag expediente PJ Catamarca</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaId</code>
										...
										<TableCell>Referencia a CausasPjCatamarca (o pivote)</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaType</code>
										...
										<TableCell>'CausasPjCatamarca'</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaAssociationStatus</code>
										</TableCell>
										<TableCell>String</TableCell>
										<TableCell>Estado de vinculación</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>pendingCausaIds</code>
										</TableCell>
										<TableCell>[ObjectId]</TableCell>
										<TableCell>Opciones múltiples</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
										...
										<TableCell>String</TableCell>
										<TableCell>Término de búsqueda</TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
					...
					<Box>
						<Typography variant="subtitle1" fontWeight="bold" gutterBottom>
							Campos de CausasPjCatamarca (Pivote)
						</Typography>
						<TableContainer>
							<Table size="small">
								<TableHead>
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Boolean</TableCell>
										<TableCell>true = documento pivote</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>pivotCausaIds</code>
										...
										<TableCell>[ObjectId]</TableCell>
										<TableCell>Causas vinculadas al pivote</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>resolved</code>
										...
										<TableCell>Boolean</TableCell>
										<TableCell>Usuario eligió opción</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>selectedCausaId</code>
										</TableCell>
										<TableCell>ObjectId</TableCell>
										<TableCell>Causa elegida</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>searchTerm</code>
			...
			<TabPanel value={tabValue} index={5}>
				<Stack spacing={3}>
					<Typography variant="h6" fontWeight="bold">
						Historial de Asociación (causaAssociationHistory)
					</Typography>

					<Alert severity="info">
						El sistema trackea todos los cambios de estado en la vinculación de causas PJ Catamarca, permitiendo auditar el ciclo de vida completo de
						cada asociación.
					</Alert>
...
┌───────────────────┐
│  pending          │ ◄─── source: 'user'
│  "Causa PJ Catamarca       │      details: "Causa PJ Catamarca pendiente de verificación"
│   pendiente..."   │
└─────────┬─────────┘
          │
          ▼
  ...
  searchTerm: "162321/2020"
						...
						<TableContainer>
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										<TableCell>
											<Chip label="law-analytics-server" size="small" color="secondary" />
										</TableCell>
										<TableCell>
											<code>models/Folder.js</code>
										</TableCell>
									...
									<TableRow>
										...
										<TableCell>
											<code>controllers/folderController.js</code>
										</TableCell>
										<TableCell>Tracking en vinculación PJ Catamarca</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="law-analytics-server" size="small" color="secondary" />
										...
										<TableCell>
											<code>services/causaService.js</code>
										</TableCell>
										<TableCell>Tracking en selección múltiple</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="eje-workers" size="small" color="warning" />
										</TableCell>
										<TableCell>
											<code>verification-worker.ts</code>
										</TableCell>
			...
			<TabPanel value={tabValue} index={6}>
				<Stack spacing={3}>
					...
					<Alert severity="info">El sistema rastrea métricas detalladas de actualización para cada documento elegible.</Alert>
						...
						<TableContainer>
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										<TableCell>
											<Chip label="X elegibles" size="small" variant="outlined" />
										</TableCell>
										<TableCell>
											<code>verified=true AND isValid=true AND update=true AND isPivot=false</code>
										</TableCell>
										<TableCell>Documentos que pueden actualizarse</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="X actualizados" size="small" color="success" variant="outlined" />
										</TableCell>
										<TableCell>
											<code>elegibles WHERE updateStats.today.date = hoy</code>
										</TableCell>
										<TableCell>Actualizados hoy</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="X pendientes" size="small" color="warning" variant="outlined" />
										</TableCell>
										<TableCell>
											<code>elegibles - actualizadosHoy</code>
										</TableCell>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Promedio de duración en ms</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>count</code>
										</TableCell>
										<TableCell>Total de actualizaciones</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>errors</code>
										</TableCell>
										<TableCell>Total de errores</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>newMovs</code>
										</TableCell>
										<TableCell>Movimientos nuevos encontrados</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>today.count</code>
										</TableCell>
										<TableCell>Actualizaciones hoy</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>today.hours</code>
										</TableCell>
										<TableCell>Horas de actualización hoy</TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>

...
export const DIM_LABELS: Record<DimKey, DimDef> = {
	...
	modoTerminacion: {
		...
		opciones: [
			...
			["inhabilidad_de_instancia", "Inhabilidad de instancia (27.348)"],
			["otro", "Otro"],
		],
	},
	estadoImpugnatorio: {
...
export const ACTOS_PROCESALES: [string, string][] = [
	...
	["medida_mejor_proveer", "Medida para mejor proveer (art. 36)"],
	["declara_causa_puro_derecho", "Declara puro derecho"],
	["pone_autos_para_alegar", "Pone autos para alegar (art. 94 LO)"],

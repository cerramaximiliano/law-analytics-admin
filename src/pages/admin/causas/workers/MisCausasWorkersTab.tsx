															...
															onChange={(e) =>
																setWorkerEdit(workerName, {
																	schedule: {
																		...
																		dailyRunAt:
																			e.target.value === "daily" ? worker.schedule.dailyRunAt || "09:00" : worker.schedule.dailyRunAt,
																	},
																})
															}
															helperText={
													...
													{worker.schedule.mode === "daily" ? (
														<Grid item xs={6} sm={3}>
															<TextField
																...
																onChange={(e) =>
																	setWorkerEdit(workerName, { schedule: { ...worker.schedule, dailyRunAt: e.target.value } })
																}

    ...
    <Card sx={{ height: "100%", bgcolor: alpha(color, 0.05), border: `1px solid ${alpha(color, 0.2)}` }}>
      <CardContent sx={{ py: 1.5 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
          ...
          <Box sx={{ p: 0.75, borderRadius: 1.5, bgcolor: alpha(color, 0.1), color }}>
            {icon}
          </Box>
        </Stack>
      </CardContent>
...
const FueroTable: React.FC<FueroTableProps> = ({ byFuero }) => {
  ...
  if (!fueros.length) return <Typography color="text.secondary" variant="body2">Sin datos por fuero.</Typography>;
          ...
          {fueros.map(([fuero, stats]) => (
            <TableRow key={fuero} hover>
              ...
              <TableCell align="right">
                <Typography variant="body2" color="success.main">{fmt(stats.captcha.resolved)}</Typography>
              </TableCell>
              <TableCell align="right">
              ...
              <TableCell align="right">
                <Typography variant="body2" fontWeight={600}>{fmt(stats.docs.total)}</Typography>
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
...
const DayTable: React.FC<DayTableProps> = ({ byDay }) => {
  ...
  if (!days.length) return <Typography color="text.secondary" variant="body2">Sin datos.</Typography>;
        ...
        <Stack direction="row" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap={2}>
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            <ToggleButtonGroup
              ...
              size="small"
            >
              <ToggleButton value="today" sx={{ px: 2 }}>Hoy</ToggleButton>
              <ToggleButton value="day" sx={{ px: 2 }}>Día</ToggleButton>
              <ToggleButton value="month" sx={{ px: 2 }}>Mes</ToggleButton>
            </ToggleButtonGroup>

...
const CONFIG_VARS: ConfigVar[] = [
	// Chunker
	{
		key: "chunker.chunkSizeTokens",
		label: "Chunk Size",
		section: "chunker",
		field: "chunkSizeTokens",
		editable: true,
		suffix: "tokens",
		type: "int",
		min: 100,
		max: 5000,
		description: "Cantidad de tokens por chunk. Determina el tamano de cada fragmento de texto indexado.",
	},
	{
		key: "chunker.chunkOverlapTokens",
		label: "Overlap",
		section: "chunker",
		field: "chunkOverlapTokens",
		editable: true,
		suffix: "tokens",
		type: "int",
		min: 0,
		max: 500,
		description: "Superposicion entre chunks consecutivos. Mejora la continuidad semantica entre fragmentos.",
	},
	{
		key: "chunker.charsPerToken",
		label: "Chars por Token",
		section: "chunker",
		field: "charsPerToken",
		editable: true,
		suffix: "chars/tok",
		...
		min: 1,
		max: 10,
		description: "Factor de estimacion caracteres/token para texto legal en espanol. Valores menores son mas conservadores.",
	},
	{
		key: "chunker.maxEmbeddingTokens",
		label: "Max Embedding Tokens",
		section: "chunker",
		field: "maxEmbeddingTokens",
		editable: true,
		suffix: "tokens",
		type: "int",
		min: 1000,
		max: 8191,
		description: "Limite maximo de tokens por chunk antes del embedding. Cap de seguridad vs el limite del modelo.",
	},
	// Embedding
	{
		key: "embedding.model",
		...
		field: "model",
		editable: false,
		description: "Modelo de OpenAI utilizado para generar embeddings. Configurado via variable de entorno.",
	},
	{
		...
		field: "dimensions",
		editable: false,
		description: "Dimensiones del vector de embedding. Determinado por el modelo y la configuracion del servidor.",
	},
	{
		key: "embedding.maxInputChars",
		...
		min: 1000,
		max: 100000,
		description: "Limite de caracteres por texto antes de truncar. Previene errores 400 por inputs demasiado largos.",
	},
	{
		key: "embedding.maxRetries",
		label: "Max Retries",
		section: "embedding",
		field: "maxRetries",
		editable: true,
		...
		min: 0,
		max: 10,
		description: "Cantidad maxima de reintentos ante errores transitorios (rate limit, timeout). No reintenta errores 400/401.",
	},
	// Batcher
	{
		key: "batcher.maxBatchSize",
		label: "Batch Size",
		section: "batcher",
		field: "maxBatchSize",
		editable: true,
		...
		min: 1,
		max: 2048,
		description: "Cantidad de textos por lote enviado a la API de embeddings. Balancea latencia vs throughput.",
	},
	{
		key: "batcher.flushIntervalMs",
		label: "Flush Interval",
		section: "batcher",
		field: "flushIntervalMs",
		editable: true,
		suffix: "ms",
		type: "int",
		min: 100,
		max: 30000,
		description: "Tiempo maximo de espera antes de enviar un lote parcial.",
	},
	// Model Limits
	{
		key: "modelLimits.maxTokensPerInput",
		label: "Max Tokens por Input",
		section: "modelLimits",
		field: "maxTokensPerInput",
		editable: false,
		description: "Limite hard de OpenAI por input (8191 tokens para text-embedding-3-small). No es configurable.",
	},
	// Pinecone
	{
		key: "pinecone.upsertBatchSize",
		label: "Upsert Batch Size",
		section: "pinecone",
		field: "upsertBatchSize",
		editable: true,
		suffix: "vectors",
		type: "int",
		min: 10,
		max: 1000,
		description: "Cantidad de vectores por request de upsert a Pinecone. Maximo recomendado por Pinecone: 100.",
	},
];

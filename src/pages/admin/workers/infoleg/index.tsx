...
const InfolegWorkersPage = () => {
  ...
  return (
    <MainCard>
      <Stack spacing={2.5}>
        <Box>
          <Typography variant="h3" gutterBottom>Workers Infoleg</Typography>
          <Typography variant="body2" color="text.secondary">
            Scraper de normas jurídicas argentinas — <strong>infoleg.gob.ar</strong>.
            Procesa leyes, decretos y resoluciones de forma secuencial por ID numérico.
          </Typography>
        </Box>

...
const ConfigTab = () => {
	...
	if (!config) {
		return <Alert severity="info">No hay documento de configuración todavía. El manager debe haber iniciado al menos una vez.</Alert>;
	}
			...
			<Box>
				...
				<Grid container spacing={2}>
					...
					<Grid item xs={12} sm={6}>
						<TextField
							fullWidth
							label="ID actual (cursor)"
							type="number"
							size="small"
							value={idCurrent}
							onChange={(e) => setIdCurrent(e.target.value)}
				...
				<Grid container spacing={2}>
					<Grid item xs={12} sm={6} md={3}>
						<TextField
							...
							size="small"
							value={scrBatch}
							onChange={(e) => setScrBatch(e.target.value)}
					...
					<Grid item xs={12} sm={6} md={3}>
						<TextField
							...
							size="small"
							value={scrDelay}
							onChange={(e) => setScrDelay(e.target.value)}
					...
					<Grid item xs={12} sm={6} md={3}>
						<TextField
							...
							size="small"
							value={scrMin}
							onChange={(e) => setScrMin(e.target.value)}
						/>
					</Grid>
					<Grid item xs={12} sm={6} md={3}>
						<TextField
							...
							size="small"
							value={scrMax}
							onChange={(e) => setScrMax(e.target.value)}
				...
				<Grid container spacing={2}>
					<Grid item xs={12} sm={6}>
						<TextField
							...
							size="small"
							value={vinBatch}
							onChange={(e) => setVinBatch(e.target.value)}
						/>
					</Grid>
					<Grid item xs={12} sm={6}>
						<TextField
							fullWidth
							label="Delay entre operaciones (ms)"
							type="number"
							size="small"
							value={vinDelay}
							onChange={(e) => setVinDelay(e.target.value)}
						/>
					</Grid>
				</Grid>
			</Box>
				...
				{emailEnabled && (
					<Grid container spacing={2}>
						<Grid item xs={12} sm={8}>
							<TextField fullWidth label="Email destinatario" size="small" value={emailTo} onChange={(e) => setEmailTo(e.target.value)} />
						</Grid>
						<Grid item xs={12} sm={4}>
							<TextField
								fullWidth
								label="Hora de envío (0–23)"
								type="number"
								size="small"
								value={emailHour}
					...
					<Box>
						...
						<Grid container spacing={1}>
							...
							<Grid item xs={12} sm={4}>
								...
								<Typography variant="body2" fontWeight={600}>
									{config.state.lastCycle ? new Date(config.state.lastCycle).toLocaleString("es-AR") : "—"}
								</Typography>
							</Grid>
						</Grid>
					</Box>

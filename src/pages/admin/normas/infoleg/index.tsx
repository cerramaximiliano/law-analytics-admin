...
const TIPO_LABELS: Record<string, string> = {
	...
	decreto: "Decreto",
	decreto_ley: "D/L",
	decreto_reglamentario: "D.Regl.",
	decreto_dnu: "DNU",
	resolucion: "Res.",
	resolucion_general: "R.G.",
	resolucion_administrativa: "R.A.",
	decision_administrativa: "D.A.",
	disposicion: "Disp.",
	disposicion_conjunta: "D.C.",
	acuerdo: "Acuerdo",
	convenio: "Convenio",
	otro: "Otro",
};
...
const InfolegNormasPage = () => {
	...
	return (
		...
		>
				...
				<Grid container spacing={1.5} alignItems="flex-end">
					<Grid item xs={12} sm={4}>
						<TextField
							fullWidth
							size="small"
							placeholder="Buscar por ID, número o título…"
							value={search}
								...
								{loading ? (
									...
									normas.map((n) => (
										...
										>
											...
											<TableCell>
												<Stack spacing={0.3}>
													<Chip
														...
														variant="outlined"
														color="primary"
														sx={{ maxWidth: 90, fontSize: "0.68rem" }}
													/>
											...
											<TableCell>
												<Typography variant="body2" noWrap sx={{ maxWidth: 340 }} title={n.titulo}>
													{n.titulo || "—"}
												</Typography>
											...
											<TableCell>
												<Chip label={n.vigencia} size="small" color={VIGENCIA_COLOR[n.vigencia] || "default"} />
											</TableCell>
											<TableCell>
			...
			<NormaDetailModal infolegId={detailId} open={detailId !== null} onClose={() => setDetailId(null)} />
		</MainCard>
	);
};

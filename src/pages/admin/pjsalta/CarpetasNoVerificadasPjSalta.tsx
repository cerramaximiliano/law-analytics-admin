...
const CarpetasNoVerificadasPjSalta = () => {
	...
	const fetchCausas = async (
		...
		try {
			...
			const response = await CausasPjSaltaService.getNonVerifiedCausas(params);
			...
			enqueueSnackbar("Error al cargar las carpetas no verificadas PJ Salta", {
				variant: "error",
												...
												<TableCell align="center">
													<Tooltip title="Reintentar verificación (errorCount=0, la carpeta vuelve a 'pendiente')">
														<IconButton
															...
															onClick={async () => {
																try {
																	await CausasPjSaltaService.resetVerification(getId(causa._id));
...
export default CarpetasNoVerificadasPjSalta;

 ...
 * Organiza toda la documentación de PJ Salta Workers
 */
	...
	return (
		<Stack spacing={2}>
			...
			<Alert severity="info" sx={{ mb: 1 }}>
				Scripts disponibles para probar y mantener los workers de PJ Salta.
			</Alert>
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`MONGODB_URI=mongodb://...
API_KEY=tu-api-key
PJSALTA_API_URL=https://pjsalta.lawanalytics.app
...
npx ts-node scripts/test-verification-flow.ts 162321/2020 162512/2020`}
						...
						<Box>
							...
							>
								<pre style={{ margin: 0 }}>
									{`1. Conecta a MongoDB
2. Crea documento CausasPjSalta temporal (TEMP-xxx)
						...
						<Grid item xs={12} md={4}>
							...
							>
								...
								<Typography variant="body2" gutterBottom>
									El expediente no existe en PJ Salta:
								</Typography>
								<Stack spacing={0.5}>
			...
			<TabPanel value={tabValue} index={2}>
				<Stack spacing={3}>
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>Existe en PJ Salta</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>isPrivate</code>
					...
					<Box>
						...
						>
							<pre style={{ margin: 0 }}>
								{`CausaPjSalta verificada (isValid=true)
        │
        ▼
┌───────────────────────────────────────────────────────────────┐
...
└─────────────────────┘     └─────────────────────┘     └─────────────────────┘`}
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>
											CausasPjSalta creada con <code>verified: false</code>
										</TableCell>
									</TableRow>
									<TableRow>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Vincular expediente PJ Salta a folder</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="server" size="small" color="secondary" />
									...
									<TableRow>
										...
										<TableCell>Crear/vincular CausasPjSalta</TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
			...
			<TabPanel value={tabValue} index={4}>
				<Stack spacing={3}>
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>No encontrado en PJ Salta</TableCell>
							...
							<Table size="small">
								...
								<TableBody>
									<TableRow>
										...
										<TableCell>Flag expediente PJ Salta</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaId</code>
										...
										<TableCell>Referencia a CausasPjSalta (o pivote)</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<code>causaType</code>
										...
										<TableCell>'CausasPjSalta'</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
					...
					<Box>
						<Typography variant="subtitle1" fontWeight="bold" gutterBottom>
							Campos de CausasPjSalta (Pivote)
						</Typography>
						<TableContainer>
							<Table size="small">
								<TableHead>
...
┌───────────────────┐
│  pending          │ ◄─── source: 'user'
│  "Causa PJ Salta       │      details: "Causa PJ Salta pendiente de verificación"
│   pendiente..."   │
└─────────┬─────────┘
          │
          ▼
							...
							<Table size="small">
								...
								<TableBody>
									...
									<TableRow>
										...
										<TableCell>Tracking en vinculación PJ Salta</TableCell>
									</TableRow>
									<TableRow>
										<TableCell>
											<Chip label="law-analytics-server" size="small" color="secondary" />

...
// Instancia de Axios para la API de PJ Salta (portal IOL)
const pjsaltaAxios: AxiosInstance = axios.create({
	baseURL: import.meta.env.VITE_API_PJSALTA || "https://pjsal.lawanalytics.app/api",
	timeout: 30000,
	headers: {
